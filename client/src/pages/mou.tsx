...
export default function MOU() {
  ...
  useEffect(() => {
    fetch("/api/mou-documents") // Change this URL to your actual endpoint
      .then(res => res.json())
      .then((data: MOURecord[]) => setMouDocuments(data))
      .catch(err => console.error("Failed to fetch MOU records", err));
  }, []);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Track and manage signed MOU documents of Region I institutions.</p>
      </div>
